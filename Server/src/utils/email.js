...
export const generateForgotOTPTemplate = (otp) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Please use the following One-Time Password (OTP) to complete your forgot password process. This code is valid for a limited time.</p>
                <div class="otp-container">
                    <p class="otp-code">${otp}</p>
                </div>
                <p>If you didn't request this code, please ignore this email.</p>
