      ...
      <div className="flex gap-2">
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-1">
            <p className="text-neutral-100">{card.name}</p>
            <svg
          ...
          <span className="text-xs text-green-500">{card.handle}</span>
        </div>
      </div>
      <p className="text-sm py-4 text-neutral-300">
    ...
    <>
      ...
      <div id="testimonial" className="bg-black w-full py-36 lg:py-12">
        ...
        <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
          <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-linear-to-r from-black to-transparent"></div>
          <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5">
            {[...cardsData, ...cardsData].map((card, index) => (
              <CreateCard key={index} card={card} />
            ))}
          </div>
          <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-linear-to-l from-black to-transparent"></div>
        </div>
