...
import { Mail, ArrowLeft, LoaderIcon } from "lucide-react";
...
const ForgotPassword = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-950 text-neutral-100 flex relative overflow-hidden select-none">
      ...
      <div className="absolute -top-40 -right-40 w-150 h-150 rounded-full bg-green-500/10 blur-[150px] pointer-events-none"></div>
      <div className="absolute -bottom-40 -left-40 w-150 h-150 rounded-full bg-emerald-500/5 blur-[150px] pointer-events-none"></div>

      {/* Split screen content */}
      <div className="flex w-full min-h-screen">

        {/* Left Side: Mock Interactive Resume Preview (Hero Panel) */}
        <div className="hidden md:flex md:w-1/2 bg-[#060806] items-center justify-center relative border-r border-neutral-900/60 p-12 overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
            ...
            <div className="relative w-full h-100 flex items-center justify-center mb-10">

              {/* Card 1: Main Resume Editor (Central element) */}
              <div className="absolute w-100 p-6 rounded-2xl border border-neutral-800 bg-neutral-900/60 backdrop-blur-xl shadow-2xl anim-float-slow select-none hover:border-green-500/30 transition-all duration-300">
                ...
                <div className="space-y-3.5">
                  <div className="space-y-2">
                    ...
                    <div className="h-1.5 w-full bg-neutral-800 rounded-full overflow-hidden">
                      <div className="h-full bg-linear-to-r from-green-500 to-emerald-400 w-[92%] rounded-full"></div>
                    </div>
                  </div>
            ...
            <div className="text-center max-w-sm mt-4">
              <h3 className="text-2xl font-bold text-neutral-100 tracking-tight">Crafting careers, one block at a time.</h3>
              <p className="text-sm text-neutral-400 mt-2 leading-relaxed">Create high-quality, professional resumes in minutes with our drag-and-drop builder.</p>
            </div>
          ...
          <div className="w-full max-w-md bg-neutral-900/30 md:bg-transparent p-6 md:p-0 rounded-2xl border border-neutral-800/50 md:border-none backdrop-blur-md md:backdrop-blur-none">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <button
                ...
                disabled={isLoading}
              >
                {isLoading ? <LoaderIcon className="animate-spin" size={18} /> : "Send Reset Link"}
              </button>
            </form>
          </div>
        </div>
